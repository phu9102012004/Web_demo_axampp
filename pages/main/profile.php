...
<main class="container flex" style="gap:40px;margin-top:20px">
    <aside style="width:220px">
        ...
        <ul class="acc-menu">
            <li class="<?php echo $page == 'info' ? 'active' : ''; ?>"><a href="?view=info">Thông tin tài khoản</a></li>
            <li class="<?php echo $page == 'orders' ? 'active' : ''; ?>"><a href="?view=orders">Đơn hàng của bạn</a></li>
            <li class="<?php echo $page == 'pass' ? 'active' : ''; ?>"><a href="?view=pass">Đổi mật khẩu</a></li>
            <li class="<?php echo $page == 'addr' ? 'active' : ''; ?>"><a href="?view=addr">Sổ địa chỉ</a></li>
        </ul>
    </aside>
            ...
            <table class="order-table">
                ...
                <tbody>
                    <?php if (mysqli_num_rows($query_orders) === 0) : ?>
                        <tr><td colspan="5" style="text-align:center;padding:18px">Không có đơn hàng nào.</td></tr>
